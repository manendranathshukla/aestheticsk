...
urlpatterns = [
    ...
    path('services/<int:pk>',service,name="servicepage"),
    ...
    path('aesthetic/viewServiceImages/<int:pk>',viewServiceImage,name="viewServiceImage"),
    path('aesthetic/addRoomImage/',addRoomImage),
    path('aesthetic/addServiceImage/',addServiceImage),
    path('aesthetic/delRoom/<int:pk>',delRoom),
    path('aesthetic/delRoomImage/<int:pk>',delRoomImage),
    path('aesthetic/delServiceImage/<int:pk>',delServiceImage),
